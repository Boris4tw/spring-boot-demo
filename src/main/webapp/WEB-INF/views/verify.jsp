									...
									<div class="form-group">
										<div class="input-group">
											...
											<input class="input" type="text" required="required"
												maxlength="1" id="password_1"></input> <input class="input"
												type="text" required="required" maxlength="1"
												id="password_2"></input> <input class="input" type="text"
												required="required" maxlength="1" id="password_3"></input> <input
												class="input" type="text" required="required" maxlength="1"
												id="password_4"></input> <input class="input" type="text"
												required="required" maxlength="1" id="password_5"></input>
										</div>
									</div>
									<div class="form-group">
